...
Partial Public Class deduction
    ...
    End Sub
    Partial Private Sub Ondeduction_dateChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_deduction_type", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_deduction_date", DbType:="Date")>  _
	Public Property deduction_date() As System.Nullable(Of Date)
		Get
			Return Me._deduction_date
		End Get
		Set
			If (Me._deduction_date.Equals(value) = false) Then
				Me.Ondeduction_dateChanging(value)
				Me.SendPropertyChanging
				Me._deduction_date = value
				Me.SendPropertyChanged("deduction_date")
				Me.Ondeduction_dateChanged
			End If
		End Set
	End Property
...
Partial Public Class mandatory_deduction
	...
	Private _deduction_value As System.Nullable(Of Double)
    ...
    Partial Private Sub Ondeduction_typeChanged()
    End Sub
    Partial Private Sub Ondeduction_valueChanging(value As System.Nullable(Of Double))
    End Sub
    Partial Private Sub Ondeduction_valueChanged()
    End Sub
    Partial Private Sub Ondeduction_formatChanging(value As String)
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_deduction_value", DbType:="Float")>  _
	Public Property deduction_value() As System.Nullable(Of Double)
		Get
			Return Me._deduction_value
		End Get
		Set
...
Partial Public Class netpay
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_generated_date", DbType:="Date")>  _
	Public Property generated_date() As System.Nullable(Of Date)
		Get
			Return Me._generated_date
		End Get
		Set
			If (Me._generated_date.Equals(value) = false) Then
				Me.Ongenerated_dateChanging(value)
				Me.SendPropertyChanging
