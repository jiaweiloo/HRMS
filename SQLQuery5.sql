...
CREATE TABLE [dbo].[deduction] (
    ...
    [deduction_value]  FLOAT (53)   NOT NULL,
...
CREATE TABLE [dbo].[mandatory_deduction] (
    ...
    [deduction_value]  DECIMAL(18, 2)   NULL,
    [deduction_format] VARCHAR (20) NULL,
    PRIMARY KEY CLUSTERED ([deduction_id] ASC)
);

INSERT INTO [dbo].[People] VALUES ('HR10001',10001,'hr123','Jason','950612-10-5326','1995-06-12','Male','0105422863','jason@gmail.com','Kuala Lumpur','HR','HR Dept.',5,0,15);
INSERT INTO [dbo].[People] VALUES ('MAN10001',10002,'man123','Bryan','900112-10-5856','1990-01-12','Male','0108562495','bryan@gmail.com','Kuala Lumpur','Manager','HR Dept.',5,0,15);
INSERT INTO [dbo].[People] VALUES ('STF10001',10003,'staff123','Jimmy','940806-10-5856','1994-08-06','Male','0108452395','jimmy@gmail.com','Petaling Jaya','Staff','IT Dept.',5,0,15);
INSERT INTO [dbo].[People] VALUES ('STF10002',10004,'staff123','Jun Kit','960619-10-5856','1996-06-19','Male','0121234567','jjzaii@gmail.com','Rawang','Staff','IT Dept.',5,0,15);
INSERT INTO [dbo].[People] VALUES ('STF10003',10005,'staff123','Jackson','970619-10-5856','1997-06-19','Male','0121888867','jackson@gmail.com','Klang','Staff','IT Dept.',5,0,15);

INSERT INTO [dbo].[Leave] VALUES ('L00001','2018-03-14','2018-03-10',2,'SICK','STF10001','Approved','2018-03-11');
INSERT INTO [dbo].[Leave] VALUES ('L00002','2018-04-14','2018-04-10',2,'SICK','STF10001','Pending',null);

INSERT INTO [dbo].[netpay] VALUES (30001,'STF10001',21,1,3600.15,'2018-04-11',110.21,50.12);
INSERT INTO [dbo].[netpay] VALUES (30002,'STF10002',22,0,4600.15,'2018-04-15',110.21,50.12);
INSERT INTO [dbo].[netpay] VALUES (30003,'STF10003',20,2,2800.15,'2018-03-11',110.21,50.12);
	
INSERT INTO [dbo].[deduction] VALUES (20001,'extraholiday',200,'money','STF10001','2018-04-11');
INSERT INTO [dbo].[deduction] VALUES (20002,'rentcompanyitems',200,'money','STF10001','2018-04-11');
